import { AccessorOrValue, Getter, NoInfer, PropGetterValue, TableState, Updater } from './types'
...
export function functionalUpdate<T>(updater: Updater<T>, input: T): T {
    return typeof updater === 'function' ? (updater as DataUpdateFunction<T>)(input) : updater
}
