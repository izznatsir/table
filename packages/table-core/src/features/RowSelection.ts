...
export type RowSelectionInstance<TGenerics extends PartialGenerics> = {
    ...
    getToggleAllRowsSelectedProps: <TGetter extends Getter<ToggleRowSelectedProps>>(
        userProps?: TGetter
    ) => undefined | PropGetterValue<ToggleRowSelectedProps, TGetter>
    getToggleAllPageRowsSelectedProps: <TGetter extends Getter<ToggleRowSelectedProps>>(
        userProps?: TGetter
    ) => undefined | PropGetterValue<ToggleRowSelectedProps, TGetter>
    ...
    getInstance: <TGenerics extends PartialGenerics>(
        ...
        return {
            ...
            getFilteredSelectedRowModel: memo(
                () => [instance.getState().rowSelection, instance.getGlobalFilteredRowModel()],
                (rowSelection, rowModel) => {
                    if (!Object.keys(rowSelection).length) {
                        return {
                            rows: [],
            ...
            getIsAllRowsSelected: () => {
                const preFilteredFlatRows = instance.getPreGlobalFilteredRowModel().flatRows
                const { rowSelection } = instance.getState()
            ...
            getIsSomePageRowsSelected: () => {
                const paginationFlatRows = instance.getPaginationRowModel().flatRows
                return instance.getIsAllPageRowsSelected() ? false : !!paginationFlatRows?.length
            },
            ...
            getToggleAllPageRowsSelectedProps: (userProps) => {
                ...
                const initialProps: ToggleRowSelectedProps = {
                    onChange: (e: MouseEvent | TouchEvent) => {
                        instance.toggleAllPageRowsSelected((e.target as HTMLInputElement).checked)
                    },
