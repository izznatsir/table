...
export type VisibilityInstance<TGenerics extends PartialGenerics> = {
    ...
    getToggleAllColumnsVisibilityProps: <TGetter extends Getter<ToggleAllColumnsVisibilityProps>>(
        userProps?: TGetter
...
export const Visibility = {
    ...
    createColumn: <TGenerics extends PartialGenerics>(
        ...
        return {
            ...
            toggleVisibility: (value) => instance.toggleColumnVisibility(column.id, value),
            ...
            getToggleAllColumnsVisibilityProps: (userProps) => {
                const props: ToggleAllColumnsVisibilityProps = {
                    onChange: (e: MouseEvent) => {
                        instance.toggleAllColumnsVisible((e.target as HTMLInputElement)?.checked)
                    },
                    type: 'checkbox',
                    title: 'Toggle visibility for all columns',
                    checked: instance.getIsAllColumnsVisible(),
                    indeterminate:
                        !instance.getIsAllColumnsVisible() && instance.getIsSomeColumnsVisible()
                            ? 'indeterminate'
                            : undefined,
                }
