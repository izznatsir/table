...
export const Grouping = {
    getDefaultColumn: <TGenerics extends PartialGenerics>(): GroupingColumnDef<TGenerics> => {
        return {
    ...
    getInstance: <TGenerics extends PartialGenerics>(
        ...
        return {
            ...
            getColumnGroupedIndex: (columnId) => instance.getState().grouping?.indexOf(columnId),
    ...
    createCell: <TGenerics extends PartialGenerics>(
        ...
        return {
            ...
            getIsAggregated: () =>
                !cell.getIsGrouped() && !cell.getIsPlaceholder() && row.subRows?.length > 1,
